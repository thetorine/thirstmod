...
import com.thetorine.thirstmod.core.content.packs.ContentLoader.DrinkModifier;
...
public class ItemInternalDrink extends Item {
				...
				if(!world.isRemote) {
					...
					if(addItem) {
						 ...
						 if(stack.stackSize <= 0) {
							 return new ItemStack(ItemLoader.water_cup);
						 }
	...
	public ItemStack onEaten(ItemStack stack, World world, EntityPlayer player) {
		if(!world.isRemote) {
			...
			player.inventory.addItemStackToInventory(new ItemStack(ItemLoader.cup));
		}
		return stack;
	}
