...
import com.thetorine.thirstmod.common.network.PacketDrink;
import com.thetorine.thirstmod.common.utils.DrinkLists;

public class GuiDrinkStore extends GuiContainer {

	private TileEntityDS tile;

	public GuiDrinkStore(InventoryPlayer player, TileEntityDS tile) {
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		switch (par1GuiButton.id) {
			case 0: {
				...
				ThirstMod.network.sendToServer(new PacketDrink(tile.page, tile.amountToBuy, tile.canBuy, tile.xCoord, tile.yCoord, tile.zCoord));
				break;
			}
			case 1: {
