...
public class Config {
	public Configuration config = new Configuration(new File(ThirstMod.getMinecraftDir(), "/config/thirstmod.cfg"));
	...
	public boolean setupConfig() {
		...
		DISABLE_THIRST_LOSS_FROM_SLEEP = Boolean.parseBoolean(get("Thirst Loss from Sleep", "General", true, "Turns on or off the ability to lose thirst sleep while sleeping.").getString());
